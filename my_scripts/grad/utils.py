...
# [height, width, depth]
def load_image(path, normalize=True, height=224, width=224):
    """
    args:
    ...
    # resize to 224, 224
    resized_img = skimage.transform.resize(crop_img, (height, width), preserve_range=True) # do not normalize at transform. 
    return resized_img
...
#     print(cam.shape)
    ...
    cam = resize(cam, (height,width), preserve_range=True)
