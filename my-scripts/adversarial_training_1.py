...
logger.info("Evaluate adversarially trained model on clean test set")
...
logger.info("Evaluate adversarially trained model on original adversarial samples")
